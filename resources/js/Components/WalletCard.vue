        ...
        <div class="balance">
            ...
            <div class="right">
                <a href="#" class="button" data-bs-toggle="modal"
                    ...
                    <ion-icon name="add-outline" role="img"
                        class="md hydrated" aria-label="add
                        outline"></ion-icon>
                </a>
            </div>
        </div>
            ...
            <div class="item">
                <a href="app-cards.html">
                    <div class="icon-wrapper bg-success">
                        <ion-icon name="card-outline" role="img"
                            class="md hydrated" aria-label="card
                            outline"></ion-icon>
                    </div>
                    <strong>Cards</strong>
                </a>
            ...
            <div class="item">
                <a href="#" data-bs-toggle="modal"
                    ...
                    <div class="icon-wrapper bg-warning">
                        <ion-icon name="swap-vertical" role="img"
                            class="md hydrated" aria-label="swap
                            vertical"></ion-icon>
                    </div>
